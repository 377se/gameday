<template>
  <div
    class="uk-grid uk-grid-small uk-margin-large-bottom uk-margin-large-top product-list-slider uk-flex-nowrap"
    uk-grid
...
export default {
  ...
  methods:{
    async getList(){
      ...
      var _this = this
      await this.$axios.get('/webapi/Article/getArticleList?lookUpBrand=falseproductType='+_producttype+'&seoName='+_seoname+'&pageSize='+_pagesize+_params)
      .then(function(res){
