...
export default {
  ...
  methods:{
    async getList(){
      ...
      var _this = this
      await this.$axios.get('/webapi/'+this.$i18n.locale+'/Article/getArticleListByCategoryId?sortorder=3&lookUpBrand=false&productType='+_producttype+'&seoName='+_seoname+'&pageSize='+_pagesize+_params)
      .then(function(res){
