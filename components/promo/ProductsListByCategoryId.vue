<template>
  <div
    class="uk-flex uk-grid-small uk-margin-large-bottom uk-margin-large-top product-list-slider"
...
export default {
  ...
  methods:{
    async getList(){
      ...
      var _this = this
      await this.$axios.get('/webapi/Article/getArticleListByCategoryId?productType='+_producttype+'&seoName='+_seoname+'&pageSize='+_pagesize+_params)
      .then(function(res){
