    ...
    <template
      ...
      <template
        ...
        <SeoHead
          ...
          :canonical="metadata.Canonical.replace(`/c/${$route.params.categoryid}`,`/${$route.params.parentid}/${$route.params.categoryid}`).replace(`/c/${$route.params.parentid}/${$route.params.parentid}/${$route.params.categoryid}`,`/c/${$route.params.parentid}/${$route.params.categoryid}`)"
