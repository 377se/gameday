...
export default {
  ...
  methods:{
    async forgotten() {
        ...
        var _this = this;
        await this.$axios.post('https://api.gameday.shopping/webapi/account/PostUpdatePassword',{
    ...
    try {
      const [g] = await Promise.all([
        await context.app.$axios.$post(
          'https://api.gameday.shopping/webapi/account/PostValidateGuid?guid=' +context.route.params.guid
        )
      ]);
      return {
        guidok: g
