    ...
    try {
      const [a, p, c, s, sb] = await Promise.all([
        await context.app.$axios.$get(
          process.env.API_URL + '/webapi/'+this.$i18n.locale+'/Article/GetArticleListByGender?pageNum='+ pageNum +'&seoName=nba&gender=barn&teamIdList='+teamIdList
        ),
        await context.app.$axios.$get(
        ...
        await context.app.$storyapi.get(`cdn/stories${process.env.STORYBLOK_CATALOGUE}/${this.$i18n.locale}/nba-shop/barn`, {
          version: version,
