<template>
  <section>
    ...
    <div class="uk-container uk-container-large uk-padding-small">
      ...
      <div
        class="uk-grid-small uk-child-width-1-2 uk-child-width-1-3@s uk-child-width-1-4@m uk-child-width-1-5@l"
        uk-grid
    ...
    try {
      const [a, p, c, s, sb] = await Promise.all([
        await context.app.$axios.$get(
          '/webapi/Article/GetArticleListByGender?pageNum='+ pageNum +'&seoName=nba&gender=barn&teamIdList='+teamIdList
        ),
        await context.app.$axios.$get(
        ...
        await context.app.$storyapi.get(`cdn/stories/nba-shop/barn`, {
          version: version,
