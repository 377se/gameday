...
export default {
  ...
  async fetch() {
    try {
      const url = `/webapi/${this.$i18n.locale}/Article/GetArticleDetailsExtension?teamName=null&articleId=${this.$route.params.articleid}&cartId=${this.$route.query.cartid}&validateMembership=false`;
